...
export default function CreateMarquees() {
  ...
  const HandleSaveData = (e) => {
    ...
    axios.post(`${process.env.REACT_APP_BASE_URL}/admin/marquees` , data , {
        headers: {
  ...
  return (
    <div className="relative md:ml-64 bg-default-skin">
      ...
      <div className="flex flex-wrap min600">
        ...
        <h1 className='text-2xl text-black font-bold mb-3'>Add Marquee</h1>
        <form className='mt-4 shadow-md p-4 rounded bg-white'>
        <div className="mb-6">
          <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Marquee Content</label>
          <textarea id="message" rows="6" required="required" name="message" onChange={(e) => setContent(e.target.value)} className="p-2.5 w-full bg-white border border-gray-300 focus:border-gray-300 focus-within:border-gray-300 focus:ring-gray-300 text-gray-900 text-sm rounded-lg dark:focus:ring-gray-300 dark:focus:border-gray-300"></textarea> 
        </div>
        <div className='flex'>
